        ...
        <div class="layui-body">
            ...
            <div style="padding: 15px;">
                <div class="layui-btn-group">
                    <a href="<?php echo url('add'); ?>" class="layui-btn">添加权限</a>
                </div>
                <table class="layui-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $v['id']; ?></td>
                            <td><?php echo str_repeat('-',$v['level']*3)?><?php echo $v['title']; ?></td>
                            <td>
                                <form class="layui-form" action="">
                                     <div class="layui-form-item">
                                        <div class="layui-input-block" style="margin-left:0;">
                                          <input type="checkbox" data-id="<?php echo $v['id']; ?>" lay-text="启用|停用" lay-filter="switchBtn" name="switch" lay-skin="switch" <?php if($v['status'] == 1): ?>checked<?php endif; ?>>
                                        </div>
                                      </div>
                                </form>
                            </td>
