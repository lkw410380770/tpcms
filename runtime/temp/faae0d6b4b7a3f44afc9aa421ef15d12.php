            ...
            <div style="padding: 15px;">
                <form class="layui-form" action="" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" required value="<?php echo $data['title']; ?>" name="title" lay-verify="required" value="" placeholder="标题" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                      <div class="layui-form-item">
                        <label class="layui-form-label">属性</label>
                        <div class="layui-input-block">
                          <input type="checkbox" name="attr[1]" value="1" <?php if(in_array((1), is_array($data['attr'])?$data['attr']:explode(',',$data['attr']))): ?>checked<?php endif; ?> title="图片">
                          <input type="checkbox" name="attr[2]" value="2" <?php if(in_array((2), is_array($data['attr'])?$data['attr']:explode(',',$data['attr']))): ?>checked<?php endif; ?> title="推荐">
                          <input type="checkbox" name="attr[3]" value="3" <?php if(in_array((3), is_array($data['attr'])?$data['attr']:explode(',',$data['attr']))): ?>checked<?php endif; ?> title="头条">
                          <input type="checkbox" name="attr[4]" value="4" <?php if(in_array((4), is_array($data['attr'])?$data['attr']:explode(',',$data['attr']))): ?>checked<?php endif; ?> title="加粗">
                        </div>
                      </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="" cols="200" name="desc" rows="10"><?php echo $data['desc']; ?></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-upload">
                                ...
                                <div class="layui-upload-list">
                                    <img class="layui-upload-img" src="/public/<?php echo $data['litpic']; ?>" width="180" src="" id="demo1">
                                    <p id="demoText"></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php foreach($diyFields as $k=>$v):switch($v['field_type']): case "1": ?>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                       <input type="text" name="<?php echo $v['field_ename']; ?>" value="<?php echo $data[$v['field_ename']]; ?>" placeholder="<?php echo $v['field_cname']; ?>" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                            <?php break; case "2": ?>
                                <div class="layui-form-item">
                                    <label class="layui-form-label"><?php echo $v['field_cname']; ?></label>
                                    <div class="layui-input-block">
                                       <textarea name="<?php echo $v['field_ename']; ?>" cols="200" rows="10"><?php echo $data[$v['field_ename']]; ?></textarea>
                                    </div>
                                </div>
                            <?php break; case "3": if(!empty($v['field_value'])): $values = explode(',',$v['field_value']);?>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        ...
                                        <input type="radio" name="<?php echo $v['field_ename']; ?>" <?php if($v1 == $data[$v['field_ename']]): ?>checked<?php endif; ?> value="<?php echo $v1; ?>" title="<?php echo $v1; ?>">
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <?php if(is_array($values) || $values instanceof \think\Collection || $values instanceof \think\Paginator): $i = 0; $__LIST__ = $values;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                          <input type="checkbox" value="<?php echo $v1; ?>" <?php if($v1 == $data[$v['field_ename']]): ?>checked<?php endif; ?> name="<?php echo $v['field_ename']; ?>[]" title="<?php echo $v1; ?>">
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea id="demo" name="content" style="display: none;"><?php echo $data['content']; ?></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">点击</label>
                        <div class="layui-input-block">
                            <input type="text" name="click" value="<?php echo $data['click']; ?>" placeholder="点击" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
