<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:32:"../template/default/article.html";i:1534496866;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="pos-address">
        <ol class="breadcrumb">
            ...
            <li class="active">可穿戴设备App外包提升硬件产品的价值</li>
        </ol>
    </div>
    <section class="list">
        <div class="list-left">
            <div class="content">
                <h1><?php echo $art['title']; ?><br /><span><?php echo date("Y-m-d",$art['time']); ?></span></h1>
                <?php echo $art['content']; ?>
                <div class="prev-next-box">
                    <a href="javascript:;">上一篇:哈哈哈</a>
                    <a href="javascript:;">下一篇:呵呵呵</a>
                </div>
            </div>
        </div>
                ...
                <div class="links-box">
                    ...
                    <div class="beian"> <img src="<?php echo $skin; ?>/images/备案图标.png" style="float:left;">
                        <p style="color:#939393;">贵公网安备 52010302000522号
                            <a href="javascript:;">贵州海鑫盛科技有限公司</a> &nbsp;&nbsp;黔ICP备15006187号</p>
                    </div>
                </div>
            </div>
        </div>
